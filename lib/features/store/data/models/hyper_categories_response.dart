...
class HyperCategoriesResponse {
  ...
  factory HyperCategoriesResponse.fromJson(Map<String, dynamic> json) =>
      _$HyperCategoriesResponseFromJson(json);
}
...
class HyperCategoriesData {
  ...
  factory HyperCategoriesData.fromJson(Map<String, dynamic> json) =>
      _$HyperCategoriesDataFromJson(json);
}
...
class HyperCategory {
  ...
  factory HyperCategory.fromJson(Map<String, dynamic> json) =>
      _$HyperCategoryFromJson(json);
}
